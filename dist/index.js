...
/***/ function(module, exports, __webpack_require__) {
	...
	var _videoBox = __webpack_require__(160);
...
/***/ function(module, exports) {
	...
	var RTC = function () {
	    function RTC() {
	        ...
	        this.chromeVersion = this.isMozNav ? 0 : parseInt(navigator.userAgent.match(/Chrom(e|ium)\/([0-9]+)\./)[2]);
	        ...
	        this.IceCandidate = window.RTCIceCandidate || RTC.window.mozRTCIceCandidate;
	    ...
	    _createClass(RTC, [{
	        ...
	        key: 'getStunAndTurnServers',
	        value: function getStunAndTurnServers() {
	        ...
	        key: 'setBandwidth',
	        value: function setBandwidth(sdp) {

	            if (this.isMozNav /* || navigator.userAgent.match( /Android|iPhone|iPad|iPod|BlackBerry|IEMobile/i ) */) return sdp;
	            ...
	            try {
	                for (var _iterator = this.conf.bandwidth[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var key = _step.value;

	                    var regexp = new RegExp('a=mid:' + key + '\r\n', 'g');
	        ...
	        value: function mediaUP() {
	            ...
	            return new Promise(function (res, err) {
	                navigator.userMedia(_this.conf.constraints, function (stream) {
	                    return res(window.URL.createObjectURL(stream));
	                }, err);
	            });
	        }
	    }]);
